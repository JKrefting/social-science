...
if __name__ == "__main__":
    ...
    with db_con:
        ...
        for row in thread_rows:
            ...
            raw_time = datetime.strptime(raw_time, '%d. %B %Y, %H:%M')
            thread_time = datetime.__str__(raw_time)
            ...
            try:
                ...
                raw_time = raw_time[raw_time.find("(") + 1:raw_time.find(")")]
                raw_time = datetime.strptime(raw_time, '%d. %B %Y, %H:%M')
                post_time = datetime.__str__(raw_time)
            except IndexError:
            ...
            if post_info['is new']:
                ...
                with io.open(os.path.join(SAVE_PATH, file_name), 'w', encoding='utf8') as file:
